...
#include <sstd/boost/graph/graph_traits.hpp>
#include <sstd/boost/foreach.hpp>
#include <CGAL/tags.h>

#include <sstd/boost/bimap.hpp>
#include <sstd/boost/bimap/multiset_of.hpp>
#include <sstd/boost/bimap/set_of.hpp>
#include <sstd/boost/range.hpp>
#include <sstd/boost/range/join.hpp>
#include <sstd/boost/unordered_map.hpp>
#include <sstd/boost/unordered_set.hpp>
#include <sstd/boost/shared_ptr.hpp>
#include <sstd/boost/container/flat_set.hpp>
