...
// <sstd/boost/type_traits/detail/has_binary_operator.hpp>
...
// do not include <sstd/boost/random.hpp> either
// it includes <sstd/boost/type_traits/has_binary_operator.hpp>
#  define BOOST_RANDOM_HPP
// <sstd/boost/type_traits/detail/has_prefix_operator.hpp> fails as well
...
// <sstd/boost/type_traits/detail/has_postfix_operator.hpp> fails as well
...
// Boost Parameter headers are included: <sstd/boost/parameter/config.hpp>
// defines the value to 8, if it is not yet defined.
// The CGAL BGL properties mechanism includes
// <sstd/boost/graph/named_function_params.hpp>, that includes
// <sstd/boost/parameter/name.hpp>, and maybe other Boost libraries may use
...
#  include <sstd/boost/container/flat_map.hpp>
#endif
