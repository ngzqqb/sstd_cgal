...
#include <sstd/boost/graph/compressed_sparse_row_graph.hpp>
#if BOOST_VERSION >= 104400 // at this version kolmogorov_max_flow become depricated.
#include <sstd/boost/graph/boykov_kolmogorov_max_flow.hpp>
#else
#include <sstd/boost/graph/kolmogorov_max_flow.hpp>
#endif
#else
namespace MaxFlow
{
