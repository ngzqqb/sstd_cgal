...
// respective type in sstd/boost/cstdint.hpp.
// sstd/boost/cstdint.hpp is preferred over cstdint as there are numerous
...
#define CGAL_REPLACEMENT_HEADER "<sstd/boost/cstdint.hpp>"
